...
\[
f_x'(\theta)
=\cos\theta-\dfrac{x}{8\cos^2\theta}
=\dfrac{\cos^3\theta-\dfrac{x}{8}}{\cos^2\theta}
\]
である。ここで、
\[
...
V
=\pi\int_0^8
\left\{1-\left(\dfrac{x}{8}\right)^{\frac{2}{3}}\right\}^{3}
\,dx
\]
...
&=24\pi
\left(\dfrac{1}{3}-\dfrac{3}{5}+\dfrac{3}{7}-\dfrac{1}{9}\right)\\
&=\dfrac{128\pi}{105}
\end{aligned}
\]
